    ...
    public BeginningPanel(GameFrame parent) {
        ...
        startButtonLabel.addMouseListener(new MouseAdapter() {
        	...
        	public void mouseClicked(MouseEvent e) {
        		parent.swapPanel(GameFrame.SELECT_PANEL);//부모의 컨텐트팬을 변경하도록 함수 호출
        	}
        });
        ...
        ruleButtonLabel.addMouseListener(new MouseAdapter() {
        	@Override
        	public void mouseClicked(MouseEvent e) {
        ...
        wordEditButtonLabel.addMouseListener(new MouseAdapter() {
        	@Override
        	public void mouseClicked(MouseEvent e) {
        ...
        showLankingButtonLabel.addMouseListener(new MouseAdapter() {
        	@Override
